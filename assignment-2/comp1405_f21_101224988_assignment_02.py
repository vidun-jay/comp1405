...
print(running_total, " - (divide by 3 and round down)")

#add it to the integer that is one more than itself
running_total = running_total + (cmd_line_arg + 1)
print(running_total, " - (add to integer 1 more than itself)")
...
running_total += input
print(running_total, " - (add to input function call)")

#multiply it by 7.181918
running_total = running_total * 7.181918
print(running_total, " - (multiply by 7.181918)")
...
print(running_total, " - (convert to char)")